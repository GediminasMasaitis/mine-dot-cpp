...
void game_map_generator::generate_with_mine_density(game_map& m, point starting_position, bool guarantee_opening, double mine_density)
{
...
void game_map_generator::generate_with_mine_count(game_map& m, point starting_position, bool guarantee_opening, int mine_count)
{
	auto area = m.width * m.height;
	auto coordinates = std::vector<point>();
