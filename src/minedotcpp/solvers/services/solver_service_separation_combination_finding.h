	...
	namespace solvers
	{
		namespace services
		{
			...
			private:
				...
				void validate_predictions(const unsigned char map_size, std::vector<unsigned char>& m, std::vector<int>& results, const unsigned min, const unsigned max, std::mutex* sync) const;
