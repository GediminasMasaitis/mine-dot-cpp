...
void solver_service_separation::thr_find_combos(const solver_map& map, border& border, unsigned int min, unsigned int max, const vector<cell>& empty_cells, const CELL_INDICES_T& cell_indices, mutex& sync) const
{
...
void solver_service_separation::find_valid_border_cell_combinations(solver_map& map, border& border) const
{
	auto border_length = border.cells.size();
...
int solver_service_separation::SWAR(int i) const
{
	i = i - ((i >> 1) & 0x55555555);
...
bool solver_service_separation::is_prediction_valid(const solver_map& map, const border& b, unsigned int prediction, const vector<cell>& empty_cells, const CELL_INDICES_T& cell_indices) const
{
